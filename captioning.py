...
from dataset import SoccerNetCaptions, PredictionCaptions, collate_fn_padd, collate_fn_gpt
...
def main(args):
    ...
    if not args.test_only:
        ...
        dataset_Valid_metric  = dataset_Valid #SoccerNetCaptions(path=args.SoccerNet_path, features=args.features, split=args.split_valid, version=args.version, framerate=args.framerate, window_size=args.window_size_caption)
